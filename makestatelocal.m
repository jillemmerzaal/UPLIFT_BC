...
%bekijken hoeveel datapunten er zijn voor 1 voledige cyclus  --> misschien
%de hoeveelheid samples terugbrengen naar een gemiddelde van die Ook voor
%mijn stides in gait.
...
%%% So in our case might be usefull to plot x=acceleration and y = velocity?
%%%% of x = acceleration and y = acceleration/second --> play with this! to get a good image of the phase plane